...
const Genarate_quest = () => {
  ...
  useEffect(() => {
    if (selectedFile) {
      ...
      router.push("/genarate-questions/loading"); 
    }
  }, [selectedFile, router]);
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-gray-100">
      <h1 className="text-[42px] font-bold mb-4">Genarate Questions</h1>
      ...
      Upload your PDF and start a conversation — ask questions, explore content, and get instant answers, all in one place.
      </p>
