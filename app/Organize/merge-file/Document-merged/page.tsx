...
export default function PDFViewer() {
  ...
  return (
    <>
      ...
      <div className="flex  w-full h-full bg-[#e6e6ee]">
        {/* Main content area */}
        <div className="flex-1 flex justify-center items-start bg-[#EAEAEE] p-4 ">
        ...
        {/* Sidebar */}
        <div className="w-72 bg-green-100 h-screen p-4 flex flex-col">
          {/* File name header */}
          <div className="mb-6 ">
          ...
          <div className="relative mb-4">
            ...
            >
              ...
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className={`transition-transform duration-200 mr-10 ${
