...
pdfjs.GlobalWorkerOptions.workerSrc = `https://unpkg.com/pdfjs-dist@2.14.305/build/pdf.worker.min.js`;
        ...
        <div className="flex items-start justify-center bg-[#E6E6ED] h-[calc(100vh-108px)] w-full">
          ...
          {!showFlattening && !showUploading && showFile && (
            <div className="w-full flex items-start justify-center h-full relative">
              ...
              <input type="checkbox" id="sidebar" className="hidden peer" />
              <label
                htmlFor="sidebar"
                className="peer-checked:-translate-x-[300px] h-full relative transition-all duration-300 min-[850px]:hidden"
              >
                <div className="rounded-full bg-gray-500 pr-3 pl-1 py-3 z-50 left-7 top-2 translate-x-3 absolute">
                  <img
              ...
              {/* Sidebar */}
              <div
                className="w-1/5 max-[850px]:translate-x-[300px] top-28 right-0 bottom-0 min-w-[300px] px-4 py-6 shadow-lg h-full flex flex-col gap-y-2 max-[850px]:fixed peer-checked:translate-x-0 transition-all duration-300"
                style={{
              ...
              >
                ...
                <div className="flex items-center w-full">
                  ...
                  <div className="flex items-center justify-center p-2 bg-[#06044B] rounded-r-xl min-h-[40px] border-l border-white group">
                    <img
                      src="./FLATTEN-PDF/dropdown.png"
                      className="h-4 w-4 group-focus:rotate-180 transition-all duration-300"
                      alt=""
                    />
                  </div>
                </div>
                ...
                <div className="flex items-center justify-center w-full bg-[#06044B] min-h-[40px] rounded-lg gap-x-2">
                  <img
                ...
                <div className="flex items-center justify-center w-full bg-transparent border border-black/30 min-h-[40px] rounded-lg gap-x-2">
                  <img
