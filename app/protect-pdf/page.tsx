      ...
      {!secured ? (
        selectedFiles.length === 0 ? (
          <div className="flex flex-col items-center justify-center w-full max-w-2xl px-4">
            <h1 className="text-black font-semibold text-2xl mb-8">Protect PDF Files</h1>
            <div
          ...
          <div className="bg-[#e1e3eb] m-0 p-0 font-sans w-full">
            ...
            <main className="flex flex-col md:flex-row min-h-[calc(100vh-32px)]">
              <section className="flex-1 flex flex-col items-center justify-center bg-[#e1e3eb] p-4">
                {processing ? (
                  <div className="processing-container">
                    <div className="image-transition">
                      <img
                        alt="Personal letter template document with header and text"
                        className="w-[120px] h-[140px] object-contain"
                        height="140"
                        src="https://storage.googleapis.com/a1aa/image/2224e993-b65b-49b6-00ed-b0358ad44623.jpg"
                        width="120"
                      />
                      ...
                      <img
                        alt="Red PDF file icon with folded corner"
                        className="w-[120px] h-[140px] object-contain"
                        height="140"
                    ...
                    <div className="securing-text">Securing PDF</div>
              ...
              <aside className="w-full md:w-[320px] bg-gradient-to-b from-[#d9f0d9] to-[#d9e0eb] p-6 flex flex-col justify-between">
                <div>
                  <h2 className="font-bold text-black text-base mb-2 text-center">Protect PDF</h2>
        ...
        <div className="bg-[#e0e2eb] w-full">
          <header className="bg-white border-b border-gray-300">
            <div className="max-w-full px-4 py-2 font-bold text-black text-[14px]">Protect PDF</div>
          </header>
          <main className="flex min-h-[calc(100vh-36px)]">
            <section className="flex-1 flex flex-col items-center justify-center gap-2 bg-[#e0e2eb] px-4">
              <img
                alt="Red PDF file icon with folded corner on pink background"
                className="w-[160px] h-[200px] rounded-xl drop-shadow-md"
                height="200"
                src="https://storage.googleapis.com/a1aa/image/e2d21a1c-a062-442f-23ae-072e1bf44239.jpg"
                width="160"
              />
              <p className="text-[10px] text-[#9a9a9a]">personal-letter-template.pdf (62.64 KB)</p>
              <p className="text-[14px] font-semibold text-black">PDFs are secured now!</p>
            </section>
            <aside className="w-[320px] bg-gradient-to-b from-[#d7f0d9] to-[#e0e2eb] px-6 py-8 flex flex-col gap-4">
              ...
              <button
                ...
                onClick={() => alert("Download functionality triggered!")}
              >
              ...
              <button
                className="w-full flex items-center justify-center gap-2 bg-[#050a3d] text-[10px] text-white py-2 rounded-md"
                onClick={() => alert("Print functionality triggered!")}
              >
              ...
              <div className="flex gap-2">
                <button
                  ...
                  onClick={() => alert("Share functionality triggered!")}
                >
                  <i className="fas fa-share-alt text-[10px]"></i>
                </button>
                <button
                  className="flex-1 flex items-center justify-center gap-2 border border-[#9a9a9a] text-[10px] text-black py-2 rounded-md"
                  onClick={() => alert("Delete functionality triggered!")}
                >
