...
//   const [visible, setVisible] = useState<Visible>({ file: false, hamburger: false });
//   const [openFolderMenuIndex, setOpenFolderMenuIndex] = useState<number | null>(null);
//   const [openFileMenuIndex, setOpenFileMenuIndex] = useState<number | null>(null); // for file 3-dots
...
//   return (
//     <div className="flex flex-col items-center justify-start p-2 bg-[#E6E6ED] rounded-lg w-full min-h-screen">
//       {/* Header */}
//       <div className="flex items-center justify-between w-full">
//         <div className="flex items-center gap-x-4">
//           <h2
//             className="font-semibold text-[#555555] w-fit text-2xl cursor-pointer"
//             onClick={() => setFileSelection("PrintDrive")}
//           >
//             PrintDrive
//           </h2>
//           {fileSelection !== "PrintDrive" && (
...
//         {/* Add Button */}
//         <div
//           className="flex bg-white rounded-full items-center relative cursor-pointer p-2 px-4"
//           onClick={() => setVisible((prev) => ({ ...prev, file: !prev.file, hamburger: false }))}
//         >
//           <img src="./plus.png" className="h-3 w-3 object-scale-down mr-2" alt="" />
//           <p className="text-black font-normal">Add</p>
//           {visible.file && (
//             <div className="absolute top-12 right-12 bg-white p-2 rounded-lg shadow z-50 min-w-[190px] flex flex-col">
//               <div className="flex items-center gap-2 hover:bg-[#06044B] hover:text-white text-black cursor-pointer rounded-t-xl py-2 px-2 border-b border-gray-200 group">
//                 <img src="./newfolder.png" className="h-5 w-5 group-hover:hidden" alt="" />
//                 <img src="./newfolder-white.png" className="h-5 w-5 hidden group-hover:inline" alt="" />
//                 <p>New Folder</p>
//               </div>
//               <div className="flex items-center gap-2 hover:bg-[#06044B] hover:text-white text-black cursor-pointer py-2 px-2 group">
//                 <img src="./upload.png" className="h-5 w-5 group-hover:hidden" alt="" />
//                 <img src="./upload-white.png" className="h-5 w-5 hidden group-hover:inline" alt="" />
//                 <p>Upload File</p>
//               </div>
//               <div className="flex items-center gap-2 text-gray-400 font-thin rounded-b w-full py-2 px-2 border-t border-black/20 pointer-events-none cursor-default">
//                 <img src="./upload.png" className="h-5 w-5 object-scale-down" alt="" />
...
//             placeholder="Search"
//           />
//           <img src="./search.png" className="absolute h-4 w-4 top-3 left-3" alt="" />
//         </div>

//         <div className="bg-white rounded-lg flex items-center px-4 py-2 gap-x-1">
//           <img src="./filter.png" className="h-3 w-3 object-scale-down" alt="" />
//           <p className="text-black font-normal text-sm">Filter</p>
//         </div>

//         <div
//           className="relative bg-white rounded-lg flex items-center px-4 py-2 group"
//           onClick={() => setVisible((prev) => ({ ...prev, hamburger: !prev.hamburger, file: false }))}
//         >
//           <img src="./hamburger.png" className="h-6 w-7" alt="" />
//           {visible.hamburger && (
//             <div className="absolute top-10 right-0 bg-white p-2 rounded-lg shadow z-50 min-w-[170px] flex flex-col">
//               {["Name", "Size", "Last Modified"].map((item, index) => (
//                 <div
//                   key={index}
//                   className="pl-3 py-2 text-[#555555] hover:bg-[#06044B] hover:text-white rounded-lg cursor-pointer"
//                 >
//                   {item}
//                 </div>
//               ))}
...
//               className="relative flex items-center justify-between bg-white rounded-lg p-2 min-w-[150px] w-1/5 max-[340px]:w-full cursor-pointer"
//             >
//               <div className="flex items-center gap-x-2" onClick={() => setFileSelection(folder)}>
//                 <img src="./folder.png" className="h-6 w-6 object-scale-down" alt="" />
//                 <p className="text-black font-thin">{folder}</p>
//               </div>
//               <img
