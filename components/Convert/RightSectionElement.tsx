...
export default function RightSectionElement({ text, src, onClick, link }: RightSectionElementProps) {
    return (
        <Link href={link} className="flex items-center justify-between p-2 rounded-md">
